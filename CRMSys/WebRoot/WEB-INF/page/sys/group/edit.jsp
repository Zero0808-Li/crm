...
<body>
	<s:form name="form1" method="post" action="sysUserGroupAction_update.do"
		namespace="/sys">
		<s:hidden name="id" />
		<div class="mtitle">
					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									<s:textfield name="name" cssClass="input" cssStyle="width: 90%" />
								</td>
							...
							<tr>
								...
								<td colspan="3">
									<s:textarea name="remark" id="remark" rows="3" cssStyle="width: 96%"></s:textarea>
								</td>
							</tr>
						</table>
					</div>
